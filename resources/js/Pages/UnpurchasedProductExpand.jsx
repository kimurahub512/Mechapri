...
const UnpurchasedProductExpand = () => {
                        ...
                        <div className="flex flex-col w-full rounded-[40px] bg-white shadow-[0_4px_36px_0_rgba(0,0,0,0.10)] p-[70px_230px_92.5px_226px] ">
                            <div className="flex flex-col items-center gap-[24px]">
                                <div className="flex flex-row items-center gap-[0px]">
                                    <div className="flex flex-col items-center gap-[6px] p-[3px]">
                                        <div className="flex w-[360px] px-[64px] py-[7px] justify-center items-center rounded-[14px] bg-[#F6F6F6] mx-auto relative ">
                                            <div className="flex h-[348px] max-w-[232px] flex-col justify-center items-center flex-shrink-0 relative logo">
                                                <img src={photo1} alt="main" className="h-[348px] max-w-[232px] w-full object-cover" />
                                            </div>
                                        </div>
                                        <div className="flex w-[360px] px-[64px] py-[7px] justify-center items-center rounded-[14px] bg-[#F6F6F6] mx-auto relative ">
                                            <div className="flex h-[348px] max-w-[232px] flex-col justify-center items-center flex-shrink-0 relative logo">
                ...
                <section className="flex flex-col items-start gap-[24px] px-4 md:hidden w-full pt-[32px] bg-[#FFF] mt-[-12px]">
                    ...
                    <section className="flex flex-col items-start gap-[25px] w-full">
                        ...
                        <div className="flex flex-col w-full rounded-[10px] bg-white shadow-[0_4px_36px_0_rgba(0,0,0,0.10)] px-4 py-4">
                            {/* 1211:  image */}
                            <div className="flex flex-row items-center gap-[7px] py-[16px]">
                                <div className="flex flex-col items-center gap-[6px]">
                                    <div className="flex w-full px-[27px] py-[3px] justify-center items-center rounded-[6px] bg-[#F6F6F6] mx-auto relative">
                                        {/* Blurred image */}
                                        {/* <div className="flex w-full max-w-[98px] flex-col justify-center items-center flex-shrink-0 relative"> */}
                                            <img src={photo1} alt="main" className="h-[147px] w-[98px]] object-cover rounded-[6px]" />
                                        {/* </div> */}
                                    </div>
                                    <div className="flex w-full px-[27px] py-[3px] justify-center items-center rounded-[6px] bg-[#F6F6F6] mx-auto relative">
                                        {/* Blurred image */}
                            ...
                            <div className="flex flex-col items-center gap-[4px] mt-[24px]">
                                ...
                                <div className="flex flex-row items-center gap-[4px]">
                                    <span className="text-[#363636] font-['Noto Sans JP'] font-bold text-[36px] leading-[48px]">300</span>
                                    <span className="text-[#363636] font-['Noto Sans JP'] font-bold text-[20px] leading-[23px]">円</span>
                                </div>
                            </div>
