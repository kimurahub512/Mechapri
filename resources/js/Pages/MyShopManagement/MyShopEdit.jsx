...
const MyShopEdit = () => {
    ...
    const confirmSubmit = () => {
        ...
        router.post('/myshop/update', submitData, {
            onSuccess: () => {
                setShowSuccessMessage(true);
                setTimeout(() => setShowSuccessMessage(false), 3000);
                // Clear the image from formData after successful submission
                setFormData(prev => ({
                    ...prev,
                    image: null
                }));
    ...
    return (
        ...
        {/* Success Message */}
        {showSuccessMessage && (
            <div className="fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg" style={{ zIndex: 10000 }}>
