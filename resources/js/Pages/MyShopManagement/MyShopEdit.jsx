...
const MyShopEdit = () => {
    ...
    return (
        ...
        <div className="shopmanagement-root flex flex-col w-full overflow-x-hidden md:flex-row">
            ...
            {/* Mobile Main Section */}
            <main className="inline-flex md:hidden flex-col items-start" style={{width: vw(343), paddingTop: vw(34), paddingBottom: vw(80), marginRight: vw(16), marginLeft: vw(16), gap: vw(16)}}>
