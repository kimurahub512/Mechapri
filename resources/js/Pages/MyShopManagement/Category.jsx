                ...
                <div className="block md:hidden mx-4 mt-[32px] flex flex-col items-start gap-8">
                            ...
                            <div className="flex flex-col items-start py-5 px-4 gap-2 rounded-[10px] bg-white shadow-[0px_4px_36px_0px_rgba(0,0,0,0.10)] self-stretch">
                                <div className="flex flex-col items-start justify-between w-full">
                                    ...
                                    <div
                                        ...
                                        className="flex flex-row items-center py-[12px] gap-[4px] cursor-pointer hover:opacity-80 transition-opacity"
                                    >
                    ...
                    {categories && categories.length > 0 && (
                        <div className="flex flex-col gap-4 w-full">
                            <h2 className="text-[#363636] font-['Noto_Sans_JP'] text-[20px] font-bold leading-[24px]">カテゴリ一覧</h2>
                            {categories.map((category) => (
                                <div key={category.id} className="flex flex-col items-start py-4 px-4 gap-3 rounded-[10px] bg-white shadow-[0px_4px_36px_0px_rgba(0,0,0,0.10)] self-stretch">
                                    <div className="flex flex-row items-start justify-between w-full">
                                        <div className="flex flex-col gap-2">
                                            <span className="text-[#363636] font-['Noto_Sans_JP'] text-[18px] font-bold leading-[24px]">{category.title}</span>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="flex items-center gap-2 w-[80px] h-[32px] px-3 rounded-[5px] bg-[#E9E9E9] hover:bg-[#D9D9D9] transition-colors cursor-pointer"
                                            >
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2 17.9997H18M2 17.9997V13.9997L10 5.99975M2 17.9997L6 17.9997L14 9.99974M10 5.99975L12.8686 3.1311L12.8704 3.1294C13.2652 2.73451 13.463 2.53672 13.691 2.46264C13.8919 2.39738 14.1082 2.39738 14.3091 2.46264C14.5369 2.53667 14.7345 2.73424 15.1288 3.12856L16.8686 4.86836C17.2646 5.26437 17.4627 5.46247 17.5369 5.6908C17.6022 5.89164 17.6021 6.10799 17.5369 6.30883C17.4628 6.537 17.265 6.7348 16.8695 7.13025L16.8686 7.1311L14 9.99974M10 5.99975L14 9.99974" stroke="#767676" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                ...
                >
                        ...
                        <div className="flex flex-col items-center gap-4 self-stretch">
                            <div className="flex flex-col items-start py-5 px-[50px] gap-4 rounded-[10px] bg-white shadow-[0px_4px_36px_0px_rgba(0,0,0,0.10)] self-stretch">
                                <div className="flex flex-row items-start justify-between w-full">
                                    ...
                                    <div
                                        onClick={() => router.visit('/shop-newproducts')}
                                        className="flex flex-row items-center p-[12px] gap-[4px] cursor-pointer hover:opacity-80 transition-opacity"
                                    >
                                        <img src={list} alt="list" className="w-[16px] h-[16px]" />
                                        <span className="text-[#363636] font-noto text-[14px] font-medium leading-[10px]">
                                            詳細を見る
                    ...
                    {categories && categories.length > 0 && (
                        <div className="flex flex-col gap-6 w-full">
                            <h2 className="text-[#363636] font-['Noto_Sans_JP'] text-[28px] font-bold leading-[36px]">カテゴリ一覧</h2>
                            {categories.map((category) => (
                                <div key={category.id} className="flex flex-col items-start py-6 px-[50px] gap-4 rounded-[10px] bg-white shadow-[0px_4px_36px_0px_rgba(0,0,0,0.10)] self-stretch">
                                    <div className="flex flex-row items-start justify-between w-full">
                                        <div className="flex flex-col gap-3">
                                            <span className="text-[#363636] font-['Noto_Sans_JP'] text-[24px] font-bold leading-[32px]">{category.title}</span>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <button
                                                onClick={() => router.visit(`/myshop/category/${category.id}/edit`)}
                                                className="flex items-center gap-2 w-[100px] h-[40px] px-4 rounded-[5px] bg-[#E9E9E9] hover:bg-[#D9D9D9] transition-colors cursor-pointer"
                                            >
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2 17.9997H18M2 17.9997V13.9997L10 5.99975M2 17.9997L6 17.9997L14 9.99974M10 5.99975L12.8686 3.1311L12.8704 3.1294C13.2652 2.73451 13.463 2.53672 13.691 2.46264C13.8919 2.39738 14.1082 2.39738 14.3091 2.46264C14.5369 2.53667 14.7345 2.73424 15.1288 3.12856L16.8686 4.86836C17.2646 5.26437 17.4627 5.46247 17.5369 5.6908C17.6022 5.89164 17.6021 6.10799 17.5369 6.30883C17.4628 6.537 17.265 6.7348 16.8695 7.13025L16.8686 7.1311L14 9.99974M10 5.99975L14 9.99974" stroke="#767676" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                                <span className="flex-1 text-[#767676] font-['Noto_Sans_JP'] text-[14px] font-bold leading-[20px]">編集</span>
                                            </button>
                                            <button
                                                onClick={() => handleDelete(category)}
                                                className="flex items-center gap-2 w-[100px] h-[40px] px-4 rounded-[5px] bg-[#E9E9E9] hover:bg-[#D9D9D9] transition-colors cursor-pointer"
                                            >
                                                <img src={recyclebin} alt="delete" className="w-5 h-5" />
                                                <span className="flex-1 text-[#767676] font-['Noto_Sans_JP'] text-[14px] font-bold leading-[20px]">削除</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
