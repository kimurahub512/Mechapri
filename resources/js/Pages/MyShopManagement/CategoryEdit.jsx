    ...
    return (
        <>
            ...
            <div className="shopmanagement-root flex flex-col w-full overflow-x-hidden md:flex-row">
                ...
                {/* Main Section */}
                {/* MOBILE ONLY */}
                <div className="flex flex-col items-start" style={{paddingRight: vwR(16, 15), paddingLeft: vwR(16, 15), paddingBottom: vwR(80, 40), paddingTop: vwR(24, 134), marginRight: vwR(0, 169), marginLeft: vwR(0, 109), gap: vwR(16, 22)}}>
