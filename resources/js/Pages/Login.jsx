                            ...
                            <form onSubmit={submit} className="flex flex-col w-full" style={{ gap: '45px' }}>
                                <div className="flex flex-col" style={{ gap: '16px' }}>
                                    ...
                                    <div className="flex flex-col" style={{ gap: '8px' }}>
                                        <label style={{ fontSize: '16px', fontWeight: 'bold', fontFamily: '"Noto Sans JP", sans-serif', color: '#363636' }}>
                                            メールアドレスを入力
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div 
                                        className="flex flex-row items-center gap-[8px] mt-[-10px]"
                                    ...
                                    >
                                        {data.remember ? (
                                            ...
                                            <svg
                                                ...
                                                fill="none"
                                            >
                                                <rect x="3" y="3.71973" width="18" height="18" rx="2" stroke="#E9E9E9" strokeWidth="2" fill="none"/>
                                            </svg>
                                        )}
                                ...
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div className="text-center">
                                        <Link href="/register" className="inline-flex items-center" style={{ textDecoration: 'none' }}>
                                    ...
                                    <div className="text-center">
                                        <Link href="/forgot-password" className="inline-flex items-center" style={{ textDecoration: 'none' }}>
                                            <span style={{ fontSize: '14px', fontFamily: '"Noto Sans JP", sans-serif', color: '#0D0D0D' }}>
                                                パスワードを忘れた場合は
                                            </span>
                                            <span style={{ fontSize: '14px', fontFamily: '"Noto Sans JP", sans-serif', color: '#FF2AA1', marginLeft: '4px' }}>
                            ...
                            <form onSubmit={submit} className="flex flex-col w-full" style={{ gap: '45px' }}>
                                <div className="flex flex-col" style={{ gap: '16px' }}>
                                    ...
                                    <div className="flex flex-col" style={{ gap: '2px' }}>
                                        <label style={{ fontSize: '14px', fontWeight: 'bold', fontFamily: '"Noto Sans JP", sans-serif', color: '#363636', paddingTop: '12px', paddingBottom: '6px' }}>
                                            メールアドレスを入力
                                        </label>
                                        <input
                                            type="email"
                                            ...
                                            onChange={e => setData('email', e.target.value)}
                                            autoComplete="email"
                                            style={{ fontSize: '14px', fontFamily: '"Noto Sans JP", sans-serif', color: '#000', height: '50px', borderRadius: '8px' }}
                                        />
                                        {backendErrors.email && (
                                            <div style={{ fontSize: '14px', fontFamily: '"Noto Sans JP", sans-serif', color: '#E53E3E' }}>
                                                {backendErrors.email}
                                    ...
                                    <div 
                                        className="flex flex-row items-center gap-[8px] cursor-pointer mt-[-16px]"
                                        onClick={() => setData('remember', !data.remember)}
                                    >
                                        {data.remember ? (
                                            ...
                                            <defs>
                                              <linearGradient id="paint0_linear_1198_790" x1="21" y1="12.6387" x2="3" y2="12.6387" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#FF2AA1"/>
                                                <stop offset="1" stop-color="#AB31D3"/>
                                              </linearGradient>
                                              <clipPath id="clip0_1198_790">
                                                <rect width="24" height="24" fill="white" transform="translate(0 0.719727)"/>
                                              </clipPath>
                                            </defs>
                                          </svg>
                                        ...
                                        <span className='text-[#0D0D0D] font-normal font-noto text-[12px] leading-[18px]'>パスワードを記憶する</span>
                                    </div>
                                </div>
                                {/* Submit Button */}
                                <div className="flex flex-col items-center gap-4">
                                    <button
                                        className="w-[240px] py-[13px] bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-[8px] font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
                                        type="submit"
                                        disabled={processing}
                                        style={{ fontSize: '14px', fontWeight: 'medium', fontFamily: '"Noto Sans JP", sans-serif', color: '#FFF' }}
                                    >
                                        ログイン
                                    </button>
                                    {/* Login Link */}
                                    <div className="text-center">
                                        <Link href="/register" className="inline-flex items-center" style={{ textDecoration: 'none' }}>
                                            <span style={{ fontSize: '12px', fontFamily: '"Noto Sans JP", sans-serif', color: '#0D0D0D' }}>
                                                新規登録の場合は
                                            </span>
                                            <span style={{ fontSize: '12px', fontFamily: '"Noto Sans JP", sans-serif', color: '#FF2AA1', marginLeft: '4px' }}>
                                                こちら
                                            </span>
                                        </Link>
                                    </div>
