                ...
                <div className="login-modal">
                    ...
                    <form className="login-form" onSubmit={submit}>
                        ...
                        <input
                            ...
                            autoComplete="new-password"
                        />
                        {errors.password_confirmation && <div className="login-error">{errors.password_confirmation}</div>}
                        {backendErrors.password_confirmation && <div className="login-error">{backendErrors.password_confirmation}</div>}
