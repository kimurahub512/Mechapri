                ...
                <div className="flex flex-col items-start w-[880px] min-w-[880px] max-w-[880px] gap-[24px] ">
                    ...
                    <div className="flex flex-col items-start self-stretch gap-[16px]">
                        ...
                        <div className="flex pb-[16px] flex-col items-start border-b border-[#D9D9D9] relative w-full">
                            ...
                            {/* Text */}
                            <span className="text-[#363636] font-noto font-medium text-[21px] leading-[31.5px] absolute top-[1px] left-[244px]">郊外のカフェにて</span>
                            {/* Frame 1211 */}
                            <div className="flex w-[636px] p-[16px_0px] items-start absolute right-0 top-[74px] ">
                                ...
                                <div className="h-[48px] flex-1 flex items-center gap-[8px] relative ">
                                    ...
                                    <div className="flex ml-[300px] gap-0  relative w-[80px] h-[48px]">
                                        ...
                                        <span className="text-[#AB31D3] font-noto font-bold text-[36px] leading-[54px] absolute left-[15px] top-[-3px] whitespace-nowrap">300</span>
                                    </div>
                                    {/* 121112 */}
                    ...
                    <div className="flex flex-col items-start self-stretch">
                                        <span className="text-left text-[#363636] font-noto font-medium text-[18px] leading-[32px]">めちゃプリはお客様のセキュリティ保護のため、決済システム <img src={stripe} alt="stripe" className="inline h-[18px] w-auto" /> を利用しています。</span>
                                        <span className="text-left text-[#363636] font-noto font-medium text-[18px] leading-[32px]">クレジットカード等のお支払い情報は当社には伝わらずに暗号化された状態でstripeで処理され、より安全に
                                            ご利用いただけます。</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="flex flex-col items-start w-full">
                    ...
                    <div className="flex flex-col self-stretch border-b border-[#E9E9E9] relative w-full p-[16px]">
                        ...
                        <div className="flex w-[233px] flex-col items-start gap-[4px] absolute top-[16px] left-[96px] ">
                            <span className="text-[#000] font-noto font-normal text-[14px] leading-[21px]">郊外のカフェにて</span>
                            {/* Frame 12111 */}
                            <div className="w-[44px] h-[36px] relative ">
                                ...
                                <span className="text-[#AB31D3] font-noto font-bold text-[18px] leading-normal absolute top-[9px] left-[11.44px]">300</span>
                            </div>
                        </div>
                        {/* Frame 1212 */}
